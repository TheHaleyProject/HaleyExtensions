...
namespace Haley.Utils
{
    public static class ObjectMapping
    {
        ...
        /// <returns></returns>
        public static TTarget Map<TTarget>(this DataRow source, CustomTypeConverter typeParser = null) where TTarget : class, new() //Should be a class and also should have a parameter less new constructor.
        {
        ...
        public static void Map(this DataRow source, PropertyInfo prop, object target, List<string> sourceColumnNames = null, CustomTypeConverter typeParser = null)
        {
